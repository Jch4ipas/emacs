...
(use-package vterm
 ...
 (with-eval-after-load 'vterm
    (define-key vterm-mode-map (kbd "s-<left>") (lambda () (interactive) (vterm-send-C-a)))
    (define-key vterm-mode-map (kbd "s-<right>") (lambda () (interactive) (vterm-send-C-e))))
;; Option Droite = Normal (pour taper ~, [, {, |, etc.)
